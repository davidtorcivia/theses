...
func (s *Server) refusal(what string, err error) error {
	...
	case errors.Is(err, legal.ErrInvalid), errors.Is(err, legal.ErrChanged), errors.Is(err, legal.ErrClosed), errors.Is(err, legal.ErrRecipientsChanged), errors.Is(err, mail.ErrNotConfigured), errors.Is(err, core.ErrRestoreBusy), errors.Is(err, core.ErrRestoreConflict), errors.Is(err, workflow.ErrChanged), errors.Is(err, workflow.ErrInvalid), errors.Is(err, workflow.ErrTranscriptionUnavailable), errors.Is(err, workflow.ErrQueueBusy), errors.Is(err, workflow.ErrAlreadyQueued), errors.Is(err, board.ErrDueDate), errors.Is(err, files.ErrMaintenance), errors.Is(err, board.ErrLegalReleases), errors.Is(err, board.ErrUploading), errors.Is(err, board.ErrArchived), errors.Is(err, board.ErrShow), errors.Is(err, board.ErrEmpty),
