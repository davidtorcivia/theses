...
func (s *Server) refusal(what string, err error) error {
	...
	case errors.As(err, &refused),
		...
		errors.Is(err, mail.ErrNotConfigured),
		...
		errors.Is(err, workflow.ErrQueueBusy),
		errors.Is(err, workflow.ErrAlreadyQueued),
		errors.Is(err, board.ErrDueDate),
		errors.Is(err, board.ErrLegalReleases),
		errors.Is(err, board.ErrUploading),
		errors.Is(err, board.ErrArchived),
		errors.Is(err, board.ErrShow),
		errors.Is(err, board.ErrEmpty),
		errors.Is(err, board.ErrTooLong),
		errors.Is(err, board.ErrQuestion),
		...
		errors.Is(err, files.ErrMaintenance),
		...
		errors.Is(err, files.ErrSize),
		errors.Is(err, files.ErrBadSize),
		errors.Is(err, files.ErrSwept),
		errors.Is(err, files.ErrCrossBucket),
		errors.Is(err, files.ErrNoBucket),
