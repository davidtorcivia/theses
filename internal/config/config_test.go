...
func TestLoadRejects(t *testing.T) {
	cases := []struct {
		...
		{"base URL path", "THESES_BASE_URL", "https://example.com/workspace", "only the origin"},
		{"base URL encoded path", "THESES_BASE_URL", "https://example.com/%2f", "only the origin"},
		{"base URL credentials", "THESES_BASE_URL", "https://user:password@example.com", "only the origin"},
		{"base URL query", "THESES_BASE_URL", "https://example.com/?redirect=", "only the origin"},
		{"base URL empty query", "THESES_BASE_URL", "https://example.com/?", "only the origin"},
		{"base URL fragment", "THESES_BASE_URL", "https://example.com/#workspace", "only the origin"},
		{"base URL empty host", "THESES_BASE_URL", "https://:8080", "only the origin"},
